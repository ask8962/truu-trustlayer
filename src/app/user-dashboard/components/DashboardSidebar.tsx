...
const NAV_ITEMS = [
  ...
  { id: 'nav-settings', icon: Settings, label: 'Settings', href: '/user-dashboard/settings', badge: null },
];
    ...
    <Link href={item.href} title={collapsed ? item.label : undefined}>
      ...
      >
        ...
        {!collapsed && item.badge && (
          <span className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded-full ${item.badge === 'Active' ? 'bg-green-500/15 text-green-400 border border-green-500/30' : 'bg-primary/15 text-primary border border-primary/30'
            }`}>
            {item.badge}
          </span>
        )}

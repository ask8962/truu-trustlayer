      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-8 xl:px-10 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tight">
            Not a certificate.{' '}
            <span className="text-gradient-purple">Cryptographic proof.</span>
          </h2>
          <p className="text-muted-foreground mt-4 max-w-xl mx-auto text-base">
            Every credential is backed by an immutable proof hash derived from your actual commit history. Anyone can verify it, forever.
          </p>
        </motion.div>
        ...
        >
          <p className="text-xs text-muted-foreground font-mono flex items-center justify-center gap-2">
            ...
            Credentials are derived from commit history using SHA-256 proof chains — verifiable by anyone, forever
          </p>
        </motion.div>
      </div>
    </section>

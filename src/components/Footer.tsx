...
const FOOTER_LINKS = [
  { group: 'Product', links: [{ label: 'Dashboard', href: '/user-dashboard' }, { label: 'Passport', href: '/public-capability-passport' }, { label: 'How It Works', href: '#how-it-works' }] },
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-8 xl:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="flex items-center gap-3 mt-6">
              {[
                ...
                <a
                  ...
                  aria-label={label}
                  className="p-2 rounded-lg btn-ghost text-muted-foreground hover:text-foreground transition-colors"
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          {FOOTER_LINKS?.map((group) => (
            <div key={`footer-group-${group?.group}`}>
              <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-4">{group?.group}</p>
        ...
        <div className="mt-16 pt-8 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground font-mono">
            © 2026 TRUU Technologies, Inc. All rights reserved.
          </p>
